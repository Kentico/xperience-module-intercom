...
public partial class CMSFormControls_Sites_SiteCultureChanger : FormEngineUserControl, IPostBackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            txtCulture.Text = HTMLHelper.HTMLEncode(ci.CultureName);
        }
...
");
    ...
    protected void btnHidden_Click(object sender, EventArgs e)
    {
        ...
        if ((txtCulture.Text != HTMLHelper.HTMLEncode(ci.CultureName)) && ValidationHelper.GetBoolean(hdnDocumentsChangeChecked.Value, false) && SearchIndexInfoProvider.SearchEnabled)
        {
